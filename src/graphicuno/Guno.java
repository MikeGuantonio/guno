 ...
 * @author mike
 */
public class Guno extends JFrame 
{
    static private FileHandler textLog; 
    private static final Logger log = Logger.getLogger(Guno.class.getName()); 
    ...
    public void Sleep(long sleepTime)
    {
        ...
        {
            Logger.getLogger(Guno.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    {  
        ...
        Guno.UnoIter iter = new Guno().new UnoIter(players);
